...
export const seed = async () => {
        ...
        let google = await Company.create({ name: "Google", location: "San Francisco, CA", website: "google.com"})
        let facebook = await Company.create({ name: "FaceBook", location: "Los Angeles., CA", website: "facebook.com"})
        let twitter = await Company.create({ name: "Twitter", location: "Houston, TX", website: "twitter.com"})
        let github = await Company.create({ name: "GitHub", location: "Newark, NJ", website: "github.com"})
        ...
        let rev2 = await Review.create({
            title: 'terrible',
            rating: 1,
            description: 'They never called me back',
            userId: faizah.id,
